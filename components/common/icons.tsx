...
export const CompassIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="m9 9 3 6 3-6-3-6-3 6Z" />
    </svg>
);
...
export const LanguageIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S13.636 12 12 12m0 0c-1.657 0-3.636 4.03-3.636 9m3.636-9a9.004 9.004 0 0 1-1.44-5.364c0-3.173 1.045-5.824 2.88-7.491" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 12c0 1.27-.46 2.49-1.223 3.446M21 12a9 9 0 0 0-13.19-8.63" />
    </svg>
);